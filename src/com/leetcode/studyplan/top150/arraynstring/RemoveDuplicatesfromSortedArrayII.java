...
*/
    ...
    public static void main(String[] args) {
        ...
        testCase.put("numsArrayList", new int[][]{{1,1,1,2,2,3},{0,0,1,1,1,1,2,3,3}});
        testCase.put("kArrayList", new int[]{5,7});
        testCase.put("numsOutArrayList", new int[][]{{1,1,2,2,3},{0,0,1,1,2,3,3}});
        ...
        for(int i=0;i<cntTestCase;i++){
            ...
            // 병합 메서드 실행
            System.out.printf("##########%n[TestCase %d]%nInput nums : %s%n"
                    ,i+1
